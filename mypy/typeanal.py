        ...
        if (
            ...
            item_ors_with_str = [
                ...
                or (
                    ...
                    # "type: ignore" comment need to satisfy the ProperTypePlugin.
            ...
            for idx, itm in enumerate(t.items):
                if (
                    ...
                    # Not the first item and immediately followed by a type that
                    # can OR with a string.
                    # Accessing index 1 is safe because union syntax guarantees
                    # that there exist at least 2 items.
